 ...
 *   docker exec -it claude-moodle-1 php local/admindashboard/cli/verify_school_metrics.php
 *
...
$timerangedays = (int) (get_config('local_admindashboard', 'timerangedays') ?: 180);
