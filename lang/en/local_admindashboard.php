...
$string['navitems_desc'] = 'One link per line: Title|URL|Group|Capability(optional). Group is the card heading it appears under (cards are shown in the order their group name first appears here). URL can be a site-relative path (e.g. /cohort/index.php) or a full external URL. If a capability is given (e.g. moodle/site:config), the link is only shown to users who have it in the system context; leave it out to show the link to everyone who can see this dashboard. Lines that cannot be parsed are skipped - see the warning above if any are.';
