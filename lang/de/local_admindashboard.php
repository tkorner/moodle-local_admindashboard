...
$string['navitems_desc'] = 'Ein Link pro Zeile: Titel|URL|Gruppe|Capability(optional). Gruppe ist die Kartenüberschrift, unter der der Link erscheint (Karten werden in der Reihenfolge angezeigt, in der ihr Gruppenname hier zuerst auftaucht). URL kann ein site-relativer Pfad (z.B. /cohort/index.php) oder eine vollständige externe URL sein. Ist eine Capability angegeben (z.B. moodle/site:config), wird der Link nur Nutzer/innen mit dieser Capability im System-Kontext angezeigt; ohne Angabe sehen ihn alle, die dieses Dashboard sehen können. Nicht parsebare Zeilen werden übersprungen - siehe ggf. den Hinweis oberhalb.';
